                    ...
                    <tbody>
                        @foreach ($kpis as $index => $kpi)
                            <tr>
                                ...
                                <td> Rp {{ number_format($kpi->rkap_bulan_ini, 2, ',', '.') }} </td>
                                <td> Rp {{ number_format($kpi->realisasi_bulan_ini, 2, ',', '.') }} </td>
                                <td> Rp {{ number_format($kpi->realisasi_tahun_lalu, 2, ',', '.') }} </td>
                                <td>
