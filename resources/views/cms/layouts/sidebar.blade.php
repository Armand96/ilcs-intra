        ...
        <div class="flex flex-col w-full justify-center items-center" >
            ...
            @if ($currRoleName == $superAdmin)
                ...
                <a class="text-white rounded-2xl {{ Route::currentRouteName() == 'calendars.index' ? 'menu-child-active' : 'menu-child' }} flex-col items-center justify-center flex mt-4 w-5/6 px-4 py-3"
                    ...
                    <p class="mt-2 text-sm">Event</p>
                </a>
                <a class="text-white rounded-2xl {{ Route::currentRouteName() == 'knowledges.index' ? 'menu-child-active' : 'menu-child' }} flex-col items-center justify-center flex mt-4 w-5/6 px-4 py-3"
                    ...
                    <p class="mt-2 text-sm text-center">Knowledge Management</p>
                </a>
                <a class="text-white rounded-2xl {{ Route::currentRouteName() == 'laporans.index' ? 'menu-child-active' : 'menu-child' }} flex-col items-center justify-center flex mt-4 w-5/6 px-4 py-3"
                    ...
                    <p class="mt-2 text-sm text-center">Laporan Rapat Management</p>
                </a>
