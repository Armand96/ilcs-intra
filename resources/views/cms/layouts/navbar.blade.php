            ...
            <div class="flex items-center" tabindex="0" role="button">
                ...
                <div class="btn btn-ghost btn-circle avatar">
                    <div class="w-10 rounded-full">
                        <img alt="Tailwind CSS Navbar component" src="{{ strpos(Auth::user()->image_user, 'http') !== false ? Auth::user()->image_user : url('storage/profile_picture/'.Auth::user()->image_user) }}" onerror="this.src='{{ asset('assets/images/default-profile.png') }}'" />
                    </div>
                </div>
