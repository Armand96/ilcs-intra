...
<body>
    <div class="flex lg:overflow-y-hidden flex-col lg:flex-row w-full h-screen">
        <div class="lg:w-3/6 h-full flex flex-col justify-center items-center bg-login-100">
            <div class="flex-col lg:w-5/6">
                ...
                <form class="background-inner-login overflow-hidden text-center mt-4 lg:mt-4 px-6 py-6 2x1:px-20 2xl:py-20" action="{{ route('login_user') }}" method="POST">
                    ...
                    <p class="text-sm zl:text-xl mt-4 text-login-text">
                    ...
                    <div class="mt-4 xl:mt-12">
                        ...
                        <button class="bg-login-button login-button relative z-10 text-xs xl:text-sm w-full mt-8  xl:mt-12 text-white rounded-3xl py-1 xl:py-2">
                            Login
                        </button>
        ...
        <div class="hidden lg:w-3/6 back-login lg:flex justify-center items-center h-full">
            <div class="w-5/6">
                <h1 class="text-lg xl:text-xl mt-10 2xl:mt-5 mb-12 font-semibold text-white">Welcome to <span class="text-login-text-blue">INTRANET 2.0</span> <br />Please sign in to your account</h1>
