<dialog id="my_modal_2" class="modal ">
  <div class="modal-box max-w-7xl bg-[#283358] text-white">
    ...
    <h2 class="text-dashboard-blue-right font-semibold  text-sm lg:text-xl">News Lorem, Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quibusdam dolor maxime omnis asperiores! Totam.</h2>
    <p class="mb-2 text-sm font-semibold text-white">
           19 juni 2024 | admin
          </p>
    <img src="{{ asset('assets/images/from-board/bod-1.svg') }}" alt="img" class="w-4/6 mx-auto h-72 object-cover rounded-xl" alt="">
