...
<div class="py-5 w-full flex flex-col gap-6 post-container">
    <!--  CARD Post -->
...
<dialog id="buat-post" class="modal ">
    <div class="modal-box max-w-3xl bg-[#283358]">
        ...
        <textarea name="" id="onlyText" class="w-full mt-5 h-28 rounded-xl outline-none text-white px-4 py-2 text-xs bg-[#384478FC]"></textarea>
        <div class="flex w-full">
            ...
            <button id="post-only-text" class="btn mt-4  text-white bg-[#0B5AFD] px-4 py-2 rounded-xl">Post</button>
        </div>
    </div>
